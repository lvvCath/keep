...
$sql = "UPDATE users_education SET degree=?, year=?, location=?, description=? WHERE userid = ? AND id = ?;";
...
mysqli_stmt_bind_param($stmt, "ssssii", $degree, $year, $location, $description, $userid, $id);

...
<div class="container d-flex justify-content-center">
    <div class="form px-4 shadow-lg p-3 mb-4 bg-body rounded">
    <form class="row gx-5 gy-3" id="form" name="createForm" method="POST" action="includes/signup.inc.php">
        <div class="col-12">
            ...
            <div class="col-12">
                ...
                <div class="input-group">
                    <input class="form-control" id="con_password" name="con_password" type="password" 
                        ...
                        required>
                    <div class="input-group-append">
                        <div class="input-group-text" onclick="con_password_show_hide();"> 
                            <i class="pwd-eye fa fa-eye" id="show_eye_c"></i>
                            <i class="pwd-eye fa fa-eye-slash d-none" id="hide_eye_c"></i>
                        </div>
                    </div>
                </div>
